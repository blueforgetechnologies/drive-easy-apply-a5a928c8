...
import { Package, Briefcase, Wrench, Settings, Map, Calculator, Target, Menu, FileCode, History, LogOut, ShieldCheck, MonitorUp, Hammer } from "lucide-react";
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  useEffect(() => {
    ...
    const validTabs = ['map', 'load-hunter', 'business', 'loads', 'accounting', 'maintenance', 'settings', 'roles', 'screenshare', 'development', 'changelog', 'tools'];
  ...
  const handleTabChange = (value: string) => {
    ...
    if (value === 'accounting') {
      ...
      navigate(`/dashboard/${value}?subtab=analytics`);
  ...
  const navItems = [
    ...
    { value: "tools", icon: Hammer, label: "Tools" },
