      ...
      <div className={`flex items-center gap-1 flex-shrink-0 ${
        ...
        <div className={`flex items-center overflow-hidden rounded-full ${
          ...
          {showAllTabEnabled && activeMode === 'admin' && (
            ...
            >
              All
              <span className={`badge-inset text-[10px] h-5 ${activeFilter === 'all' ? 'opacity-80' : ''}`}>{allEmailsCount}</span>
            </Button>
          )}
        ...
        <Button
          variant="ghost"
          size="sm" 
          className={`h-7 px-3 text-xs font-medium gap-1 rounded-full ${
            loadHunterTheme === 'aurora'
        ...
        >
          Skipped
          <span className={`badge-inset text-[10px] h-5 ${activeFilter === 'skipped' ? 'opacity-80' : ''}`}>{skippedCount}</span>
        </Button>

        {/* Merged Bids/Booked button group */}
        <div className={`flex items-center overflow-hidden rounded-full ${
          loadHunterTheme === 'aurora'
          ...
          >
            Bids
            <span className={`badge-inset text-[10px] h-5 ${activeFilter === 'mybids' ? 'opacity-80' : ''}`}>{bidCount}</span>
          </Button>
          ...
          >
            Booked
            <span className={`badge-inset text-[10px] h-5 ${activeFilter === 'booked' ? 'opacity-80' : ''}`}>{bookedCount}</span>
          </Button>
        </div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-52 bg-background z-50">
            ...
            {/* Additional Filters */}
            <DropdownMenuItem
              className={activeFilter === 'missed' ? 'bg-primary/10 text-primary' : ''}
              onClick={() => handleFilterChange('missed')}
            >
              Missed ({missedCount})
            </DropdownMenuItem>
            <DropdownMenuItem
              className={activeFilter === 'undecided' ? 'bg-primary/10 text-primary' : ''}
              onClick={() => handleFilterChange('undecided')}
            >
              Undecided ({undecidedCount})
            </DropdownMenuItem>
            <DropdownMenuItem
              className={activeFilter === 'waitlist' ? 'bg-primary/10 text-primary' : ''}
            ...
            <DropdownMenuItem
              className={activeFilter === 'issues' ? 'bg-primary/10 text-primary' : ''}
