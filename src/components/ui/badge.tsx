...
const badgeVariants = cva(
  "badge-glossy inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        warning: "border-warning/30 bg-warning text-white",
      },
    },
    defaultVariants: {
      variant: "default",
