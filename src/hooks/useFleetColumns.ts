...
const DEFAULT_COLUMNS: FleetColumn[] = [
  ...
  { id: "drv_pay", label: "Drv1 Pay", width: "w-[75px]", align: "right", visible: true },
  { id: "drv1_name", label: "DRV1", width: "w-[85px]", align: "left", visible: true },
  { id: "drv2_name", label: "DRV2", width: "w-[85px]", align: "left", visible: true },
  { id: "drv2_pay", label: "Drv2 Pay", width: "w-[70px]", align: "right", visible: true },
