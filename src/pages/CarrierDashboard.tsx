...
import { Truck, Package, MapPin, Calendar, DollarSign, Search, RefreshCw, Building2, Eye } from "lucide-react";
...
export default function CarrierDashboard() {
  ...
  const completedLoads = filteredLoads.filter(l => ['completed', 'delivered'].includes(l.status?.toLowerCase() || '')).length;
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">View loads assigned to carrier trucks</p>
              </div>
            </div>
