...
export default function InvoicesTab() {
  ...
  const getBillingMethodBadge = (method: string | null) => {
    switch (method) {
      case 'otr':
        return <span className="badge-puffy badge-puffy-green text-xs font-bold">OTR Solutions</span>;
      case 'direct_email':
  ...
  const getCreditApprovalBadge = (inv: InvoiceWithDeliveryInfo) => {
    ...
    switch (inv.credit_approval_status) {
      case 'approved':
        return wrapWithSource(<span className="badge-puffy badge-puffy-green text-xs font-bold">Approved</span>);
      case 'denied':
