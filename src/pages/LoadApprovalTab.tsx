                    ...
                    return (
                      <TableRow 
                        ...
                        className={cn(
                          ...
                          selectedLoadId === load.id && "!bg-none !bg-primary/10 dark:!bg-primary/20 ring-2 ring-ring/40 ring-inset"
                        )}
                      ...
                      return (
                        <TableRow 
                          ...
                          className={cn(
                            ...
                            isSelectedLoad && "!bg-none !bg-primary/10 dark:!bg-primary/20 ring-2 ring-ring/40 ring-inset"
                          )}
                        >
