  ...
  return {
    ...
    application: {
      ...
      license_info: {
        ...
        yearsExperience: 7,
        // Medical card
        medicalCardNumber: "MC-9876543",
        medicalCardExpiration: "2026-11-30",
        medicalExaminerName: "Dr. Robert Williams",
        medicalExaminerPhone: "(614) 555-0222",
        dotMedical: true,
        dotMedicalCertDate: "2024-11-30",
      ...
      employment_history: [
        {
          ...
          address: "8000 Industrial Parkway",
          city: "Columbus",
          state: "OH",
          zip: "43228",
          phone: "(614) 555-0144",
          ...
          supervisorEmail: "mreynolds@midwestfreight.example.com",
          startDate: "2023-01-15",
          endDate: "2025-01-10",
          startingSalary: "$65,000/year",
          endingSalary: "$72,000/year",
          equipmentDriven: "Dry Van 53ft",
          milesPerWeek: "2,500 - 3,000",
          reasonForLeaving: "Seeking better home time and benefits package",
          mayWeContact: true,
          subjectToFMCSR: true,
          subjectToTesting: true,
        },
        {
          companyName: "Buckeye Logistics Inc",
          position: "Over-the-Road Driver",
          address: "500 Logistics Lane",
          city: "Grove City",
          state: "OH",
          zip: "43123",
          phone: "(614) 555-0177",
          ...
          supervisorEmail: "scollins@buckeyelog.example.com",
          startDate: "2021-02-01",
          endDate: "2023-01-10",
          startingSalary: "$58,000/year",
          endingSalary: "$65,000/year",
          equipmentDriven: "Reefer 53ft",
          milesPerWeek: "2,800 - 3,200",
        ...
        },
        {
          ...
          supervisorTitle: "Driver Supervisor",
          supervisorEmail: "jortega@cohtransport.example.com",
          startDate: "2019-03-01",
          endDate: "2021-01-28",
          startingSalary: "$52,000/year",
          endingSalary: "$58,000/year",
          equipmentDriven: "Flatbed 48ft",
          milesPerWeek: "2,000 - 2,500",
      ...
      direct_deposit: {
        ...
        email: "john.smith@example.com",
        bankName: "Chase Bank",
        bankAddress: "100 Main Street, Columbus, OH 43215",
        accountType: "Checking",
        routingNumber: "021000021",
        accountNumber: "123456789012",
        confirmAccountNumber: "123456789012",
        accountHolderName: "John Andrew Smith",
        cashAppCashtag: "$JohnSmithTrucking",
        venmoHandle: "@JohnSmithTrucker",
        zelleEmail: "john.smith@example.com",
