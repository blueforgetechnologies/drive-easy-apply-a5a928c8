      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px;">
        ...
        <table style="margin-top: 30px; border-top: 1px solid #ccc; padding-top: 20px; width: 100%;">
          <tr>
            ...
            ${data.company_logo_url ? `<td style="vertical-align: bottom; text-align: center; padding-left: 12px;"><img src="${data.company_logo_url}" alt="${data.company_name}" style="max-height: 70px; max-width: 180px;" /></td>` : ''}
          </tr>
        </table>
